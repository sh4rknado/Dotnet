...
#pragma warning restore 0414
        ...
        internal static string net_http_unix_invalid_certcallback_option {
              get { return SR.GetResourceString("net_http_unix_invalid_certcallback_option", null); }
        }
        ...
        internal static string net_http_unix_invalid_certcallback_option {
              get { return SR.GetResourceString("net_http_unix_invalid_certcallback_option", @"The libcurl library in use ({0}) and its SSL backend (""{1}"") do not support custom handling of certificates. A libcurl built with OpenSSL is required."); }
        }
        internal static string net_http_unix_invalid_credential {
